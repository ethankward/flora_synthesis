...
class ChecklistSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['pk', 'checklist_name', 'checklist_type', 'checklist_state', 'external_checklist_id', 'locality',
...
class ChecklistTaxonSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.ChecklistTaxon
        fields = ['pk', 'taxon_name', 'family', 'external_id', 'rank', 'genus', 'checklist', 'observation_types']
